<!DOCTYPE html>
    <html lang="en">
        ...
        <body class="error-page coming-soon" style="background-color: #ffc107;">
            <div class='loader'>
            ...
            <div class="container">
                <div class="error-container">
                    <div class="error-info">
                        ...
                        <p style="color: #ffffff !important;">Website sedang dalam perbaikan.<br>Mohon maaf atas ketidaknyamanan nya.</p>
                    </div>
