		...
		<div class="row row-height">
			<div class="col-lg-6 content-left">
				<div class="content-left-wrapper">
					...
					<!-- /social -->
					<div>
						<figure><img src="img/req_undraw.svg" alt="" class="img-fluid" width="350"></figure>
						<h2>Open Member 2021</h2>
						<p>Merupakan program tahunan dari tahungoding untuk mencari pemuda/i yang ingin menambah wawasan dan meningkatkan <i>Skills</i> nya dibidang IT</p>
					</div>
